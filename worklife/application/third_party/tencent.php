<?php
/**
 * Tencent Weibo OAuth授权类
 *
 * 授权机制说明请大家参考微博开放平台文档：{@link http://wiki.open.t.qq.com/index.php/OAuth2.0鉴权}
 *
...
class Tencent
{
    ...
    //TencentQQ绑定需要用到的APP_ID
    public static $app_id = '100302781';
    ...
    * QQ绑定需要用到的get函数
    */
    public static function get($sUrl, $aGetParam)
    {
        global $aConfig;
        $oCurl = curl_init();
